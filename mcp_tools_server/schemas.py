...
TOOL_SPECS: dict[str, ToolSpec] = {
    ...
    "discover_toolchains": ToolSpec("discover_toolchains", "Discover toolchains", "Discover validated Node.js, Python, and Go toolchains without evaluating shell startup files.", obj({"kinds": {"type": "array", "items": {**S, "enum": ["node", "python", "go"]}, "default": ["node", "python", "go"]}}), True, False, True),
